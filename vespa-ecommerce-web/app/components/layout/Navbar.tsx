...
import {
    Menu, X, Search, ShoppingCart, ChevronDown, Package, Wrench,
    Zap, Sparkles, Tag, Loader2, ArrowRight, Heart, Phone
} from 'lucide-react';
                                    ...
                                    <div key={link.name}>
                                        {link.hasDropdown ? (
                                            <div>
                                                ...
                                                <AnimatePresence>
                                                    {activeDropdown === link.name && (
                                                        ...
                                                        >
                                                            {isLoadingCategories ? (
                                                                <div className="p-3 text-gray-500">Memuat...</div>
                                                            ) : (
                                                                categories?.map(category => {
                                                                    const Icon = getCategoryIcon(category.name);
                                                                    return (
                                                                        <Link key={category.id} href={`/products?categoryId=${category.id}`} onClick={() => setIsOpen(false)} className="flex items-center p-3 rounded-lg text-gray-600 hover:bg-gray-100">
                                                            ...
                                                            <Link href="/products" onClick={() => setIsOpen(false)} className="flex items-center justify-center p-3 rounded-md text-blue-600 font-semibold hover:bg-blue-50 transition-colors duration-200">
                                            ...
                                            <Link
                                                ...
                                                className={`
                                                    block text-lg font-semibold p-3 rounded-lg hover:bg-gray-100
